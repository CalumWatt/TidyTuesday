...
knitr::opts_chunk$set(echo = TRUE) #all chunks will be included in the final rendered version
dir()
```

## Let's download the packages we will need
...
```{r download the data, explore & filter, echo=FALSE}
...
register_google(key = "AIzaSyARi7zb1vWKzOe7jI5HZTNkD2xqwtIc1g0") 
